...
CREATE     PROCEDURE [dbo].[sp_report_CRP_Compensation_Letter_Identified_Main]  
...
BEGIN  
	...
	SELECT vcpt.idPayee, vcpt.id_plan
	  ...
	  INNER JOIN _tb_employee_identified_staff teis ON vcpt.PersonnelNumber = teis.PersonnelNumber
	  WHERE 1=1
	...
	--  WHERE vcpt.id_plan = @id_plan AND rjt.IdentifiedStaff = 'Yes'
